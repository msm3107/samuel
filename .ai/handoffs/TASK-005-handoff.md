...
8. **`import "server-only"`** keeps the helper out of any client bundle.
...
- `tests/unit/auth/organization-roles.test.ts` (new): 24 tests
- `tests/security/auth/organization-role.test.ts` (new): 50 tests, fake
  database client
